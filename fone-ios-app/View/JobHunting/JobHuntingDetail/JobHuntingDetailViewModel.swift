...
final class JobHuntingDetailViewModel: CommonViewModel {
    ...
    lazy var recruitCondition = RecruitCondition(type: jobHuntingDetail?.type, recruitmentEndDate: jobHuntingDetail?.recruitmentEndDate, dday: jobHuntingDetail?.dday, casting: jobHuntingDetail?.casting, gender: jobHuntingDetail?.gender, career: jobHuntingDetail?.career, domains: jobHuntingDetail?.domains, numberOfRecruits: jobHuntingDetail?.numberOfRecruits, ageMin: jobHuntingDetail?.ageMin, ageMax: jobHuntingDetail?.ageMax)
