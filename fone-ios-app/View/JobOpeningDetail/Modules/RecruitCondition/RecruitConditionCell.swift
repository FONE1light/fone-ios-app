...
struct RecruitCondition {
    let type, deadLine, dday, casting, gender, career: String
    let domains: [String]
    let numberOfRecruits, ageMin, ageMax: Int
    
    init?(type: String?, deadLine: String?, dday: String?, casting: String?, gender: String?, career: String?, domains: [String]?, numberOfRecruits: Int?, ageMin: Int?, ageMax: Int?) {
        guard let type = type, let deadLine = deadLine, let dday = dday, let casting = casting, let gender = gender, let career = career, let domains = domains, let numberOfRecruits = numberOfRecruits, let ageMin = ageMin, let ageMax = ageMax else { return nil }
        self.type = type
...
class RecruitConditionCell: UICollectionViewCell {
    ...
    func configure(recruitCondition: RecruitCondition) {
        ...
        deadLineLabel.text = recruitCondition.deadLine
